...
import type { ISheetData, ISheetJSON } from './interface';
 ...
 export const mergerCells = (wb)=> {
    ...
    wb.SheetNames.forEach((name)=> {
      ...
      (ws["!merges"]||[]).forEach((m) => {
        ...
        o.rows[mergeobj.s.r].cells[mergeobj.s.c].merge = [mergeobj.e.r - mergeobj.s.r, mergeobj.e.c - mergeobj.s.c];
...
export const getSheetData = (wb: WorkBook) => {
