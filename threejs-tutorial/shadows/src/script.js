...
/**
 * add Shadows
 * 1. renderer need support shadows
 * 2. geometry need cast shadows
 * 3. something can receive shadows
 * 4. the light need enabled cast shadow
 */
...
// directionamLightCameraHelper
const directionamLightCameraHelper = new THREE.CameraHelper(
  directionalLight.shadow.camera
);
directionamLightCameraHelper.visible = false;
scene.add(directionamLightCameraHelper);
