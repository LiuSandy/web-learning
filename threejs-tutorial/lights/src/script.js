...
const rectAeraLight = new THREE.RectAreaLight(0x4e00ff, 2, 1, 1);
rectAeraLight.position.set(-1.5, 0, 1.5);
rectAeraLight.lookAt(new THREE.Vector3())
scene.add(rectAeraLight);

const rectAreaLightHelper = new RectAreaLightHelper(rectAeraLight)
