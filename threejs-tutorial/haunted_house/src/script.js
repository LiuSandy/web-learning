...
grassNormalTexture.wrapST = THREE.RepeatWrapping;
...
// Door Light
const doorLigth = new THREE.PointLight("#ff7d46", 1, 7);
doorLigth.position.set(0, 2.2, 2.7);
house.add(doorLigth);
// const doorLightHelper = new THREE.PointLightHelper(doorLigth)
...
doorLigth.shadow.camera.width = 256
doorLigth.shadow.camera.height = 256
